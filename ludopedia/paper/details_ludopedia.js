...
async function scrapeProductDetails(url, browser) {
  ...
  try {
    ...
    // Save images
    const imagesDir = path.join(__dirname, "papers");
    ...
    return {
      ...
      isVisible: true,
      editors: ["Papers"], // Assuming this is fixed
...
async function main() {
  ...
  console.log("Detailed products data saved to detailed_papers_brasil.json");
